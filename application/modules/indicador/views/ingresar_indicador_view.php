                ...
                <form id ="datosIndicador" data-toggle="validator">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3"><b><p name="nom" id="nom" >Numerador&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/ </p></b><input type="text" class="form-control bfh-number-btn" name="numerador" id="numerador" required></input></div>                            
                            <div class="col-md-3"><b><p name="nom" id="nom" >Denominador </p></b><input type="text" class="form-control bfh-number-btn" name="denominador" id="denominador" required="true"></input></div>
                            <div class="col-md-1"><b><p name="nom" id="nom" >=</p></b></div>
                            <div class="col-md-3"><b><p name="nom" id="nom" >Resultado X Coeficiente </p></b><input type="text" class="form-control bfh-number-btn" name="resultado" id="resultado" readonly="true"></input></div>
                        </div>        
                    </div>
