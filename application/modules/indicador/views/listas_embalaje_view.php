        ...
        <div class="row">
            <div class='col-sm-4'>
                <div class="form-group">
                    <div><b><p name="nom" id="nom" >Fecha toma </p></b> </div>
            ...
            <div class='col-sm-4'>
                <div class="form-group">
                    <div><b><p name="nom" id="nom" >Municipio </p></b> </div>
...
<!--                        <input type='text' class="form-control" id="fechaFinalInput" required/>
            ...
            <div class='col-sm-4'>
                <div class="form-group">
                    <div><b><p name="nom" id="nom" >IPS </p></b></div>
            ...
            <div class="modal-footer">
                ...
                <!--                <a href="http://localhost/regalaletiempoatuvida/docs/FOR_501_REMISION_MUESTRAS_BIOLOGICAS.doc" download>Enlace</a>-->
            </div>
        ...
        <!--                            <th data-column-id="fecha_envio">Fecha Envio</th>-->
                                    ...
                                    <th data-column-id="numero_documento">Numero de documento</th> 
                                    <th data-column-id="id_epidemiologica"  >Código interno FIG</th> 
                                    <th data-column-id="prueba" >Exámen solicitado</th> 
