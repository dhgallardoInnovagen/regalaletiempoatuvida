...
$db['default']['hostname'] = 'regalaletiempoatuvida.com';
$db['default']['username'] = 'postgres';
$db['default']['password'] = 'E-S=fS6o0#';
$db['default']['database'] = 'bd_atlantic';
...
$db['desarrollo']['username'] = 'postgres';
$db['desarrollo']['password'] = 'postgres';
$db['desarrollo']['database'] = 'portal_indicadores';
$db['desarrollo']['dbdriver'] = 'postgre';
$db['desarrollo']['port']     = '5432';
