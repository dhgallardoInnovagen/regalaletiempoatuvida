...
<script type="text/javascript" src="<?php echo base_url() ?>public/js/funcionesInconsistencia.js"></script>
                        ...
                        <table id="gridInconsistencias" class="table table-bordered table-hover table-striped" data-toggle="bootgrid" data-ajax="true" cellspacing="0" data-show-export="true" width="100%">                
                            <thead>
                                <tr>
                                    ...
                                    <th data-column-id="nombre_usuaria">Usuaria</th>
                                    <th data-column-id="categoria">Categoria</th>
                                    <th data-column-id="fecha_encuesta">Fecha ecnuesta</th>
                                    <th data-column-id="procedencia">Procedencia</th>
                                    ...
                                    <th data-column-id="diligencia">Diligencia</th>
