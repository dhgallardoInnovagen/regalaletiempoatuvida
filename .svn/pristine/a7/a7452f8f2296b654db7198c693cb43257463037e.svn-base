...
//FileInput plugin definition
    ...
    $.fn.fileinputLocales.en = {
     ...
     $.fn.fileinputLocales.es = {
        ...
        removeTitle: 'Limipiar archivo seleccionado',
        cancelLabel: 'Cancelar',
        cancelTitle: 'Abort ongoing upload',
        uploadLabel: 'Cargar',
        uploadTitle: 'Cargar archivo seleccionado',
        msgSizeTooLarge: 'El archivo "{name}" (<b>{size} KB</b>) excede el máximo permitido para cargar <b>{maxSize} KB</b>.',
        ...
        msgFilePreviewAborted: 'File preview aborted for "{name}".',
        msgFilePreviewError: 'An error occurred while reading the file "{name}".',
        msgInvalidFileType: 'Archivo Invalido "{name}". Sólo "{types}" archivos soportados.',
        msgInvalidFileExtension: 'Extensión inválida para el archivo "{name}". sólo se permiten extensiones: "{extensions}".',
        msgValidationError: 'Error al cargar archivo',
        msgLoading: 'Loading file {index} of {files} &hellip;',
        msgProgress: 'Loading file {index} of {files} - {name} - {percent}% completed.',
        msgSelected: '{n} {files} Seleccionado',
        msgFoldersNotAllowed: 'Drag & drop files only! {n} folder(s) dropped were skipped.',
        dropZoneTitle: 'Drag & drop files here &hellip;'
    };
