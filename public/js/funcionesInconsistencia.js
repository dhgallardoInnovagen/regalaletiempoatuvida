...
function actualizarDataGridInconsistencia(verTodo) {
    ...
    var grid = $("#gridInconsistencias").bootgrid({
        url: "inconsistencia/getInconsistencias",       
        post: function ()
        {
            return {
                verTodo: verTodo
        ...
        templates: {
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col-sm-12 actionBar\"><div class=\"btn-group\" role=\"group\"><button type=\"button\" class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\"><span class=\"glyphicon glyphicon-download-alt\" aria-hidden=\"true\"> Descargar <span class=\"caret\"></span></span></button></button><ul class=\"dropdown-menu\"><li><a href=\"inconsistencia/export_data\">Pendientes de solucionar</a></li><li><a href=\"inconsistencia/export_data_all\">Todas</a></li></ul></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<button type=\"button\" class=\"btn btn-default\" onClick=\"VerTodasInconsistencias()\"><span class=\"glyphicon glyphicon-eye-open\" aria-hidden=\"true\"></span>&nbsp;Ver Todo</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type=\"button\" class=\"btn btn-default\" onClick=\"abrirVentantaNuevaInconsistencia()\"><span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\"></span>&nbsp;Adicionar inconsistencia</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>"
        },
        formatters: {
                ...
                if (row.estado === 'CREADO') {
                    ...
                    if (row.estado === 'ELIMINADO') {
                        ...
                        if (row.estado == 'SOLUCIONADO') {
                            return '<span class="label label-success">Solucionado</span>';
                        } else {
                            return '<span class="label label-warning">Editado</span>';
                        }
...
function abrirVentantaNuevaInconsistencia() {
    url = 'inconsistencia/nuevaInconsistencia';
    $('#datosInconsistencia').form("clear");
    $('#myModal').modal('show');
}
