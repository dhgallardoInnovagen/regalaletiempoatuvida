...
$(document).ready(function () {
    head =  "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col-sm-12 actionBar\">";
            ...
            +"<button type=\"button\"  class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\" onClick=\"location.href='reporte_tamizacion/exportarReporteTamizacion'\" aria-haspopup=\"true\" aria-expanded=\"false\"><span class=\"glyphicon glyphicon-download-alt\" aria-hidden=\"true\"> Descargar reporte</span>"
            +"</button>"
   ...
   var grid = $("#grid-data").bootgrid({
        ...
        url: "reporte_insatisfactorias/getReporteInsatisfactorias",
        selection: true,
        multiSelect: true,
        labels: {
            search: "Buscar"
